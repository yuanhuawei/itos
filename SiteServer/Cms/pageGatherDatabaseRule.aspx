<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Cms.PageGatherDatabaseRule" %>
    ...
    <form class="form-inline" runat="server">
        ...
        <asp:DataGrid ID="dgContents" ShowHeader="true" AutoGenerateColumns="false" DataKeyField="GatherRuleName" HeaderStyle-CssClass="info thead" CssClass="table table-bordered table-hover" GridLines="none" runat="server">
            <Columns>
                ...
                <asp:TemplateColumn>
                    <ItemTemplate><a href="pageGatherDatabaseRule.aspx?PublishmentSystemID=<%=PublishmentSystemId%>&GatherRuleName=<%# DataBinder.Eval(Container.DataItem,"GatherRuleName")%>&Copy=True">复制</a> </ItemTemplate>
                    <ItemStyle Width="60" CssClass="center" />
                </asp:TemplateColumn>
                <asp:TemplateColumn>
                    <ItemTemplate><a href="pageGatherDatabaseRule.aspx?PublishmentSystemID=<%=PublishmentSystemId%>&GatherRuleName=<%# DataBinder.Eval(Container.DataItem,"GatherRuleName")%>&Delete=True" onclick="javascript:return confirm('此操作将删除采集规则“<%# DataBinder.Eval(Container.DataItem,"GatherRuleName")%>”，确认吗？');">删除</a> </ItemTemplate>
                    <ItemStyle Width="60" CssClass="center" />
                </asp:TemplateColumn>
                <asp:TemplateColumn
        ...
        <ul class="breadcrumb breadcrumb-button">
            <input type="button" class="btn btn-success" onclick="location.href='pageGatherDatabaseRuleAdd.aspx?PublishmentSystemID=<%=PublishmentSystemId%>    ';" value="添加采集规则" />
