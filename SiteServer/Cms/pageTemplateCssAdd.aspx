  ...
  <div class="popover popover-static">
    ...
    <div class="popover-content">
      ...
      <table class="table noborder table-hover">
        ...
        <tr>
          <td width="155"><bairong:help HelpText="放置CSS代码及需要嵌入的标签" Text="模板文件内容：" runat="server" ></bairong:help></td>
          <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
      ...
      <table class="table noborder">
        <tr>
          <td class="center">
            ...
            <input type=button class="btn" onClick="location.href='pageTemplateCss.aspx?PublishmentSystemID=<%=PublishmentSystemId%>';" value="返 回" />
          </td>
        </tr>
      </table>
