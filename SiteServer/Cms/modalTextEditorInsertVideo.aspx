...
<bairong:alerts runat="server" text="请选择插入视频的方式"></bairong:alerts>
  ...
  <ul class="nav nav-pills" id="myTab">
    <li class="active"> <a href="#1" data-toggle="tab">上传视频</a> </li>
  ...
  <div class="tab-content">
    ...
    <div class="control-group tab-pane" id="2">
      <label class="control-label">请输入视频地址</label>
      <div class="controls">
  ...
  <div class="form-inline center"> 宽度：
    <asp:TextBox ID="TbWidth" Text="" class="input-small" Columns="5" MaxLength="50" runat="server"></asp:TextBox>
    <asp:RegularExpressionValidator
      ...
      runat="server"/>
    高度：
    <asp:TextBox ID="TbHeight" Text="" class="input-small" Columns="5" MaxLength="50" runat="server"></asp:TextBox>
    <asp:RegularExpressionValidator
