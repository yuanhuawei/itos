<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Wcm.PageGovInteractListAll" %>
...
<form class="form-inline" runat="server">
    ...
    <table class="table table-noborder">
      <tr>
        <td>
          ...
          时间：
          从 <bairong:DateTimeTextBox ID="tbDateFrom" class="input-small" Columns="12" runat="server" />
           至 
          <bairong:DateTimeTextBox ID="tbDateTo" class="input-small" Columns="12" runat="server" />
          关键字：
          <asp:TextBox ID="tbKeyword" style="height:20px; line-height:20px;" Size="40" runat="server"></asp:TextBox>
          <asp:Button OnClick="Search_OnClick" Text="搜 索" class="btn" runat="server"></asp:Button>
        </td>
      </tr>
    </table>
  </div>
  ...
  <div class="well well-small">
    <div style="float:left">
      ...
      &nbsp;<span class="gray">|</span>&nbsp;
      <asp:HyperLink ID="hlExport" NavigateUrl="javascript:;" runat="server" Text="导 出"></asp:HyperLink>
    </div>
