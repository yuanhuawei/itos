<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Analysis.PageAnalysisAdminLogin" %>
...
<body>
    ...
    <form class="form-inline" runat="server">
        ...
        <div class="popover popover-static">
            ...
            <h3 class="popover-title"><asp:Literal id="LtlPageTitle1" runat="server"></asp:Literal></h3>
        ...
        <div class="popover popover-static">
            <h3 class="popover-title"><asp:Literal id="LtlPageTitle2" runat="server"></asp:Literal></h3>
            <div class="popover-content">
                <!-- 为ECharts准备一个具备大小（宽高）的Dom -->
